...
class BonusRondo extends State<Bonus> {
  ...
  Future<List<DataPegawai>> getDataPegawai() async {
    final responseB = await http.get("http://timothy.buzz/juljol/get_pegawai.php");
    ...
    setState(() {
      ...
      _dataPegawai.forEach((dataDetail) {
        if (dataDetail.id_pegawai.contains(widget.list[widget.index]['id_pegawai']))
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Mohon periksa kembali data apakah ada yang tidak di isi atau tidak"),
          actions: <Widget>[
              ...
              new Expanded(
                  child: new TextField(
                    ...
                    decoration: new InputDecoration(
                        labelText: 'Masukkan Bonus Terbaru', hintText: 'Masukkan Angka'),
                  ))
            ],
          ),
          actions: <Widget>[
            ...
            children: <Widget>[
              new Expanded(
                  child: new TextField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: new InputDecoration(
                        labelText: 'Masukkan Bonus THR', hintText: 'Masukkan Angka'),
                    onChanged: (value) {
                            ...
                            child: new Table(
                              children: [
                                TableRow(children: [
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(bottom: 25),
                                    child: Text('${Bonus_barang}', style: new TextStyle(fontSize: 30.0),),
                                  )
                                ]),
                              ],
                            ),
                            ...
                            child: new Table(
                              children: [
                                TableRow(children: [
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(bottom: 25),
                                    child: Text('${Bonus_absen}', style: new TextStyle(fontSize: 30.0),),
                                  )
                                ]),
                              ],
                            ),
                            ...
                            child: new Table(
                              children: [
                                TableRow(children: [
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(bottom: 25),
                                    child: Text('${Bonus_THR}', style: new TextStyle(fontSize: 30.0),),
                                  )
                                ]),
                              ],
                            ),
